...
basisdict=<|
  ...
  "pyup"->Reverse@{y,0},
  "pzup"->Reverse@{z,0},
  "px+ipy up"->Reverse@{x+I y,0},
  "px-ipy up"->Reverse@{x-I y,0},
  "dx2-y2up"->Reverse@{(x^2 - y^2),0},
  "dz2up"->Reverse@{2z^2-x^2-y^2,0},
  "dxyup" ->Reverse@{ 2 x y,0},
  "dyzup"-> Reverse@{2 y z,0},
  "dxzup" ->Reverse@{2 x z,0},
  "sdn"->{1,0},
  "pxdn"->{x,0},
  "pydn"->{y,0},
  "pzdn"->{z,0},
